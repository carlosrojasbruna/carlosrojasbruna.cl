# Carlos Rojas Bruna — www.carlosrojasbruna.cl

Sitio personal: landing comercial bilingüe (ES/EN) con servicios de asesoría,
charlas y capacitaciones + CV académico completo.

## 🗂️ Structure

```
/
├── index.html          ← Landing page (servicios, sobre mí, contacto). Bilingüe ES/EN.
├── cv.html             ← Academic CV renderer. Never edit for content.
├── CNAME               ← Custom domain for GitHub Pages (www.carlosrojasbruna.cl)
├── data/
